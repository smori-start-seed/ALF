...
def init_pair(B, C):
    return {
        ...
        "last_harmony": 0.5,
        "kernel": {
            "R": 0.0, "G": 0.0, "B": 0.0, "Y": 0.0,
            "C": 0.0, "M": 0.0, "O": 0.0, "P": 0.0,
            "W": 0.0, "K": 0.0, "L": 0.0, "S": 0.0
        },
        "pattern": None,
        "density": 0.0
    }
...
def make_pair(angle_deg, radius):
    ...
    B = {"angle": angle, "radius": radius, "af": 0.4, "pf": 0.6, "rf": 0.5, "x": 0.0, "y": 0.0}
    C = {"angle": angle2, "radius": radius, "af": 0.6, "pf": 0.4, "rf": 0.5, "x": 0.0, "y": 0.0}
